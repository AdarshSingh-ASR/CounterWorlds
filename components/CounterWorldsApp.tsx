        ...
        <section className="teacher-main">
          ...
          {activeTab === "beliefs" && <div className="belief-view">
            ...
            <div className="constellation-map">
              ...
              {state.responses.length > 0 && state.clusters.length === 0 && <div className="no-evidence"><BrainCircuit /><p>Explanations received. {state.session.aiProvider === "openai" ? "GPT-5.6 Sol" : "Gemini 2.5 Flash"} will create the real mental-model clusters during compilation.</p></div>}
