        ...
        <section className="teacher-main">
          ...
          {activeTab === "beliefs" && <div className="belief-view">
            ...
            <div className="constellation-map">
              ...
              {state.responses.length > 0 && state.clusters.length === 0 && <div className="no-evidence"><BrainCircuit /><p>Explanations received. The AI compiler will create the real mental-model clusters during compilation.</p></div>}
